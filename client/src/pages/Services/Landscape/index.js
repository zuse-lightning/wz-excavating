    ...
    return (
        <>
            <div id="landscape-container">
                ...
                <div id="site-prep">
                    <Header className="landscape-header" as="h1">Site Preparation</Header>
                    <Header className="landscape-subheader" as="h3">Site Clearing and Grading</Header>
                    ...
                    <div id="landscape-content-container">
                        <div className="landscape-content-col">
                            ...
                            <List bulleted className="landscape-list">
                                <List.Item className="landscape-list-item">
                                    <b className="landscape-bold-text">Site Clearing:</b> We remove trees, shrubs, rocks, and debris to create a clean, obstruction-free site. This includes cutting down trees, grinding stumps, and removing underbrush, as well as demolishing and removing any existing structures that need to be cleared.
                                </List.Item>
                                <List.Item className="landscape-list-item">
                                    <b className="landscape-bold-text">Grading:</b> Our grading services involve reshaping the land to ensure proper drainage and a level surface. We use advanced equipment to cut and fill the soil, creating a balanced landscape that prevents erosion and water accumulation. This process is essential for preparing the site for foundation work and other construction activities.
                                </List.Item>
                            </List>
                        </div>
                        <div className="landscape-content-col">
                        ...
                        <div className="landscape-content-col">
                            <Header className="landscape-subheader" as="h3">Excavation and Earthmoving</Header>
                            <p className="landscape-text">
                        ...
                        <div className="landscape-content-col">
                            <Header className="landscape-subheader" id="landscape-trench-steps" as="h3">Key Services:</Header>
                            <List bulleted className="landscape-list">
                                <List.Item className="landscape-list-item">
                                    <b className="landscape-bold-text">Excavation:</b> We perform detailed excavation for foundations, basements, and utility trenches, ensuring accurate depth and alignment. This includes digging for footings, foundations, and any sub-surface structures required for your project.
                                </List.Item>
                                <List.Item className="landscape-list-item">
                                    <b className="landscape-bold-text">Earthmoving:</b> Our earthmoving services involve the relocation and reshaping of soil and rock to meet the design specifications of your project. This includes large-scale earthworks for road construction, landscaping, and creating embankments or retaining walls.
                                </List.Item>
                                <List.Item className="landscape-list-item">
                                    <b className="landscape-bold-text">Soil Stabilization:</b> We provide soil stabilization services to enhance the strength and durability of the site. This involves techniques such as soil compaction, chemical stabilization, and geotextiles to improve the load-bearing capacity and prevent erosion.
                                </List.Item>
                            </List>
                        </div>
                        <div className="landscape-content-col">
                            <Header className="landscape-subheader" as="h3">Erosion Control and Drainage Solutions</Header>
                            <p className="landscape-text">
